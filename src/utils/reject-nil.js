'use strict';
const { isNil, reject, unless } = require('ramda');
 ...
 * @param {Object|Array.<*>} functor The iterable to remove nil values from.
 * @returns {Object|Array.<*>|null|undefined} The original iterable without `null` or `undefined`
 *  values.
 */
 ...
 * @function
 * @see https://ramdajs.com/docs/#reject
 * @param {Object|Array.<*>} functor The iterable to remove nil or empty values from.
 * @returns {Object|Array.<*>|null|undefined} The original iterable without `null`, `undefined`
 *  or empty values.
 */
